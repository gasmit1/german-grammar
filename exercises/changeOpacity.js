// JavaScript Document
function changeOpacity(fieldName) {
if (document.getElementById(fieldName).style.opacity==0) {	
  document.getElementById(fieldName).style.opacity=1;
/* alert(document.getElementById(fieldName).innerText);*/
} else {	
  document.getElementById(fieldName).style.opacity=0;
}
  return;
}
